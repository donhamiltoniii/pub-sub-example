...
new (0, _view.View)(app).render();

},{"./view":"1ce4O"}],"1ce4O":[function(require,module,exports) {
...
class View {
    constructor(parent){
        ...
        this.handleButtonClick = ()=>{
            const { value  } = document.querySelector(".example-view__input");
            this.set({
                name: value
            });
            (0, _events.trigger)("change");
        };
        this.set = (update)=>{
            this.data = {
                ...this.data,
...
},{"./events":"1K5ob","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1K5ob":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}]},["iJYvl","h7u1C"], "h7u1C", "parcelRequireee66")
